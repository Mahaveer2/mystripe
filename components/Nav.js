...
function Nav() {
  ...
  return (
      <nav className={!navbar ? ('bg-gradient-to-b from-purple-400 to-indigo-500 px-2 sm:px-4 py-2.5 text-white dark:bg-gray-800'+ (active && ' h-[40vh]')) :'px-2 py-2.5 bg-white z-10 fixed w-full border-b border-gray-200 top-0' + (active && ' h-[40vh]')}> 
  <div className="container flex flex-wrap justify-between items-center mx-auto">
    ...
    <div className={active ? ' w-full md:block md:w-auto':'md:block hidden'} id="mobile-menu">
      <ul className={!navbar ? 'white-t flex  flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium':'flex  flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium'}>
        <li>
          <a href="/" className={!navbar ? 'block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-white-700 md:p-0 ' : 'block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white'} aria-current="page">Home</a>
        </li>
         <li>
        ...
        <li>
          <a href="contact/" className={!navbar ? 'block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-white-700 md:p-0 ' : 'block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white'}>Contact</a>
        </li>
      </ul>
    </div>
  </div>
