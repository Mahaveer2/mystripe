...
function Hero() {
  ...
  return (
<div class=" bg-indigo-500 flex justify-center flex-col">
  <div class="max-w-7xl flex  mx-auto py-12 px-4 sm:px-6 gap-20 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between lg:flex-row flex-col ">
    <h2 class="text-3xl tracking-tight text-white sm:text-4xl">
      <span class="block w-[400px]">
      Buy TikTok Followers Instant HQ Followers
      </span>
      <span class="block w-[450px] text-white text-base font-medium">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="lg:text-center">
      <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl"> Let’s Start - Buy TikTok Followers
</p>
      <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">Our exclusive followers will help increase engagement on your TikTok profile.
    ...
    <div class="mt-10">
      <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
        <div class="relative">
          <dt>
            <div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-gray-200 p-3 text-white">
              <img src='https://uploads.tikroyal.com/cdn/gallery/n55gez5wvebic6ngfpnj.svg'/>
            </div>
            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Fast Deleviery</p>
          </dt>
          <dd class="mt-2 ml-16 text-base text-gray-500">
          We’ll deliver your order fast, or at natural speed, Choose your preferred growth method.
            </dd>
        </div>
        ...
        <div class="relative">
          <dt>
            <div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-gray-200 p-3 text-white">
              <img src='https://uploads.tikroyal.com/cdn/gallery/onildh3ifd4blb88gmho.svg'/>
            </div>
            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Real Followers</p>
          </dt>
          <dd class="mt-2 ml-16 text-base text-gray-500">Join our loyal customer base who benefits from the best followers on the market, Become an influencer.</dd>
        </div>

        <div class="relative">
          <dt>
            <div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-gray-200 p-3 text-white">
              <img src='https://uploads.tikroyal.com/cdn/gallery/cmy93n4ff4cnlgdpycpx.svg'/>
            </div>
            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">24/7 Support
</p>
          </dt>
          <dd class="mt-2 ml-16 text-base text-gray-500">If our followers made you hungry for more, Just contact our support team, They’ll reply ASAP.</dd>
        </div>

        <div class="relative">
          <dt>
            <div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-gray-200 p-3 text-white">
              <img src='https://uploads.tikroyal.com/cdn/gallery/3pn6k00mihb14j72jw0g.svg'/>
            </div>
            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Cheap Packages</p>
          </dt>
          <dd class="mt-2 ml-16 text-base text-gray-500">This is not a dream, We REALLY offer high-quality (yet cheap) products, Don’t miss the great discounts.</dd>
        </div>
      </dl>
    </div>
  </div>
</div>
<div className='bg-green p-3 overflow-auto h-[450px] flex justify-center flex-col'>
  <h1 className='text-2xl text-white text-center pt-5'>How many TikTok followers?LET'S GO</h1>
...
<footer class="text-center lg:text-left  text-white ">
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        ...
        <p>
          Every thing is working except payments because to activate payments you need to provide me stripe keys
        </p>
      </div>
      <div class="">
  ...
  <div class="text-center p-6 bg-white text-black">
    <span>© 2021 Copyright:</span>
    <a class="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Ticktok Royal</a>
  </div>
</footer>
</div>
