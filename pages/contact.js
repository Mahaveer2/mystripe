...
>
    ...
    <Nav/>
    <div classNameName='bg-indigo-500 p-10'>
    ...
    <div className='flex justify-center items-center mt-10 p-4 shadow-md'>
  ...
  <div className="md:flex md:items-center">
    <div className="md:w-1/3">
      <button className="shadow bg-indigo-400 hover:bg-indigo-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
        Send
      </button>
    </div>
